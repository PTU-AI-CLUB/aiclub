        ...
        <div id="team" className="mb-8">
            ...
            <Grid container spacing={4} className={classes.gridContainer}>
                <Grid item xs={12} sm={6} md={4}>
                    <MuiCard role="Convenor" title="Dr. K Sathiamurthy" content="Professor, Computer Science Department" />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <MuiCard role="Chief Executive" title="Yokeswary A" content="PhD Scholar" />
                </Grid>

                <Grid item xs={12} sm={6} md={4}>
                    <MuiCard role="President" title="Sathya Krishnan" content="Student, Final Year, CSE Department" />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <MuiCard role="Secretary" title="Bibushan Sai" content="Student, Final Year, CSE Department" />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <MuiCard role="Executive Secretary" title="Shakthi S" content="Student, Final Year, CSE Department" />
                </Grid>
            </Grid>
